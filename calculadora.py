import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QSizePolicy, QWidget, QGridLayout, QPushButton, QLineEdit, \
    QSizePolicy
...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        lambda: self.display.setText(""), "background: #d5580d; color:white; font-weight: 700")
        ...
        self.add_btn(QPushButton('<-'), 2, 4, 1, 1,
         lambda: self.display.setText(self.display.text()[:-1]), "background: green; color:white; font-weight: 700")

        self.add_btn(QPushButton('1'), 3, 0, 1, 1)
        self.add_btn(QPushButton('2'), 3, 1, 1, 1)
        self.add_btn(QPushButton('3'), 3, 2, 1, 1)
        self.add_btn(QPushButton('/'), 3, 3, 1, 1)
        self.add_btn(QPushButton('='), 3, 4, 2, 1, self.eval_igual, "background: #095177; color:white; font-weight: 700")

        self.add_btn(QPushButton('.'), 4, 0, 1, 1)
        self.add_btn(QPushButton('0'), 4, 1, 1, 2)
